...
| 25.07 | Made helper functions to not repeat myself and started do_compare. Stuff is waaaay more complex than the other two, at least for now, because of edge case handling. | 30m |
| 26.07 | Compare: Started with player1 vs player2 logic comparison and solved an issue if two players are found with the same name. | 30m |
...
| 03.06 | Wrote proposal structure further | 15m |
| 04.06 | Further proposal work: Learning Goals, effort estimates, etc. | 25m |
...
| 05.07 | Made last cleaning tasks and made the script easier to read in format.py to be worked upon + communication with Emily | 1h |
| 06.07 | Discussed data enrichment with Emily, reviewed enriched dataset, and documented two-step data pipeline. | 25m |
